...
export default function ReitPortfolioDetailed() {
  ...
  const [openAsset, setOpenAsset] = useState("reit");
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        >
          <div
            style={{ width: 3, height: 22, background: P.acc, borderRadius: 2 }}
          />
          <h1
            style={{
              fontSize: 18,
        ...
        <p style={{ color: P.dim, fontSize: 9, margin: "0 0 14px 11px" }}>
          ...
          {data.reduce((s, a) => s + a.theses.length, 0)} theses · 3 asset types
          · Conviction-ranked
        </p>
        ...
        >
          {[
            { l: "TOTAL", v: `$${(total / 1000).toFixed(0)}K`, c: P.acc },
            {
              l: "REITS",
            ...
            {
              l: "TRUSTS",
              v: `$${(byType("trust") / 1000).toFixed(0)}K`,
              c: P.orn,
            },
            {
              l: "EQUITIES",
            ...
            {
              l: "AUD",
              v: `${total ? ((byCcy("AUD") / total) * 100).toFixed(0) : 0}%`,
              c: P.amb,
            },
            {
              l: "SGD",
              v: `${total ? ((byCcy("SGD") / total) * 100).toFixed(0) : 0}%`,
              c: P.ros,
            },
            {
              l: "CHF",
              v: `${total ? ((byCcy("CHF") / total) * 100).toFixed(0) : 0}%`,
              c: P.dim,
            },
          ].map((s, i) => (
            <div
